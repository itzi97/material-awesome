...
local globalKeys = awful.util.table.join(
    ...
    awful.key(
      {modkey}, "F1", hotkeys_popup.show_help, {description = "show help", group = "awesome"}
    ), -- Tag browsing
    awful.key({modkey}, "Tab", awful.tag.viewprev, {description = "view previous", group = "tag"}),
    awful.key(
      {modkey, "Shift"}, "Tab", awful.tag.viewnext, {description = "view next", group = "tag"}
    ), awful.key(
    ...
    awful.key(
      ...
      {modkey}, "p", function() _G.screen.primary.left_panel:toggle(true) end,
    ...
    awful.key({modkey}, "l", function() awful.spawn(apps.default.lock) end), awful.key(
      ...
      {modkey}, "Print", function() awful.spawn(apps.default.screenshot_gui) end,
      {description = "screenshot gui", group = "hotkeys"}
    ), -- Standard program
    awful.key(
      {modkey}, "Return", function() awful.spawn(apps.default.terminal) end,
      {description = "open a terminal", group = "launcher"}
    ), awful.key(
      {modkey, "Control"}, "r", _G.awesome.restart,
    ...
    awful.key(
      {modkey}, "'", function() _G.toggle_quake() end,
    ...
    awful.key(
      ...
      {}, "XF86PowerDown", function()
        --
      end, {description = "toggle mute", group = "hotkeys"}
    ), awful.key(
      {}, "XF86PowerOff", function() _G.exit_screen_show() end,
      {description = "toggle mute", group = "hotkeys"}
    )
)
